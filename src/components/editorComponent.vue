 ...
 * @Description: 
 * @FilePath: \GitStar-Frontend\src\components\editorComponent.vue
-->
...
<template>
  <div style="border:rgba(100,100,100) 1px solid;">
    <Toolbar style="border-bottom: 1px solid #ccc;position: relative;width: 100%;top: 0" :editor="editor"
      :defaultConfig="toolbarConfig" :mode="mode" />
    <Editor style="min-height:200px;position: sticky;bottom: 20px;" :value="props.modelValue" @onChange="$emit('update:modelValue', editor.getHtml())" :defaultConfig="editorConfig" :mode="mode" @onCreated="onCreated" />
  </div>
</template>
